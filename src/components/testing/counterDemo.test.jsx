...
describe('Counter', ()=>{
    ...
    it('check if count value increments by one when increment button is clicked', ()=>{
        ...
        const incrementBtn = getByRole("button", { name: "Increment" }); // here we are getting a reference to the button with Increment on it
        ...
        // next we will fire the button click event
